...
import ManagePropertiesInteractive from './components/ManagePropertiesInteractive';
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
          <div className="mb-8">
            ...
            <p className="text-text-secondary">
              Dodajajte, urejajte in upravljajte svoje nastanitve s cenami in razpoložljivostjo
            </p>
          </div>

          <ManagePropertiesInteractive />
        </main>
      </div>
    </div>
  );
