  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-text-secondary text-sm mt-1">Provider Portal</p>
      </div>

      <div className="bg-white rounded-2xl shadow-lg p-8">
        <div className="mb-6">
          <h2 className="font-heading font-bold text-xl text-text-primary">Welcome back</h2>
          <p className="text-text-secondary text-sm mt-1">Sign in to manage your properties and bookings</p>
        </div>
